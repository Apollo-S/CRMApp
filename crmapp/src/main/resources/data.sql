...
TRUNCATE `addresses`;
INSERT INTO `addresses` (`id`, `contractor_id`, `country_id`, `city`, `region`, `street`, `building`, `apartment`, `zip`, `date_start`, `optlock`)
VALUES
	...
	(6, 1, 1, 'м. Київ', '', 'пр-т Оболонський', 'буд. 23', 'кв. 34', '04205', '2012-01-01', 0),
	(7, 2, 1, 'м. Киев', '', 'вул. Крещатик', '12', 'кв. 45', '01045', '2012-01-01', 0),
	(8, 3, 1, 'м. Киев', '', 'бульв. Т. Шевченко', '34/1', 'кв. 2', '00023', '2012-01-01', 0),
  (9, 1, 1, 'м. Київ', '', 'вул. Горького', 'буд. 172', 'офіс 1020', '03150', '2009-01-01', 0),
  (10,2, 1, 'м. Киев', '', 'вул. Козацька', '120/4', 'літ. Б', '03022', '2015-07-01', 0);
