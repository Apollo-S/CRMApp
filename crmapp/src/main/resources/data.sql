...
INSERT INTO `document_status` (`id`, `status`, `background_color`, `color`, `allow_payment_date`, `optlock`)
VALUES 
	(1, 'Передан', '#DAA7BB', '#FFFFFF', b'0', 0),
	(2, 'Подписан', '#5FDAB1', '#FFFFFF', b'0', 0),
	(3, 'Оплачен', '#32DA14', '#FFFFFF', b'1', 0),
	(4, 'Введен', '#BD7EDA', '#FFFFFF', b'0', 0);
...
VALUES 
	...
	(2, 2, 3, '3', '2017-07-01', 500000.0, null, '4', 'На доп. услуги за 3 квартал', 0),
	(3, 3, 1, '64', '2017-06-30', 20000.0, '2017-07-10', '3', '', 0),
	(4, 3, 1, '65', '2017-07-10', 30000.0, null, '1', '', 0),
	(5, 3, 1, '66', '2017-08-15', 30001.0, null, '2', '', 0),
	(6, 4, 1, '67', '2017-09-30', 40000.0, '2017-12-01', '3', '', 0),
	(7, 3, 1, '68', '2017-09-30', 40000.0, null, '4', '', 0),
	(8, 3, 1, '69', '2017-10-31', 300000.0, null, '4', '', 0);
